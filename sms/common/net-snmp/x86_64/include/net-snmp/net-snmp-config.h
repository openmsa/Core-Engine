...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/home/ydu/workspace/sms_16.2.2/common/net-snmp/x86_64' '--with-persistent-directory=/opt/sms/spool/tmp' '--with-logfile=/opt/sms/logs/snmpd.log' '--with-mibdirs=/usr/share/snmp/mibs:' '--enable-reentrant' '--enable-ipv6' '--disable-embedded-perl' '--disable-perl-cc-checks' '--with-sys-location=Unknown' '--with-sys-contact=@@no.where' '--with-default-snmp-version=3' '--disable-debugging' '--disable-agent' '--disable-snmptrapd-subagent' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--enable-shared=no' '--with-zlib=/home/ydu/workspace/sms_16.2.2/common/zlib/x86_64' '--with-openssl=/home/ydu/workspace/sms_16.2.2/common/openssl/x86_64' 'LIBS=-ldl'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "/usr/share/snmp/mibs:"

/* default mib files to load, specified by path. */
/* #undef NETSNMP_DEFAULT_MIBFILES */

/* Define if no agent is built */
#define NETSNMP_DISABLE_AGENT 1

/* Define if no apps are built */
#define NETSNMP_DISABLE_APPS 1
...
#define NETSNMP_DEFAULT_MIBS "SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/opt/sms/spool/tmp"
...
#define SNMPLIBPATH "/home/ydu/workspace/sms_16.2.2/common/net-snmp/x86_64/lib/snmp"
#define SNMPSHAREPATH "/home/ydu/workspace/sms_16.2.2/common/net-snmp/x86_64/share/snmp"
#define SNMPCONFPATH "/home/ydu/workspace/sms_16.2.2/common/net-snmp/x86_64/etc/snmp"
#define SNMPDLMODPATH "/home/ydu/workspace/sms_16.2.2/common/net-snmp/x86_64/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/opt/sms/logs/snmpd.log"
